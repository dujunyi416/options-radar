...
任务: 从中筛选出最值得这位研究者读的论文, 分到 5 个 section 里, 输出严格 JSON (不要 markdown 代码块, 不要 JSON 之外的任何文字):

{{
  "overview_zh": "两三句中文综述: 本周共 N 篇候选, 长期期权方向 K 篇, 最值得读的 2-3 篇主题是什么, 有什么趋势/惊喜",
  "must_read": [2-4条, 真正必读的精华, 不限主题但必须与 agenda 高度相关],
  "long_dated": [3-6条, agenda 核心方向: 长期期权/LEAPS/嵌入期权/养老金/保险等],
  "methodology": [3-5条, 数值方法 / 神经网络定价 / 随机波动率模型创新],
  "empirical": [2-4条, 实证类: 隐含波动率曲面/期权流动性/期限结构等],
  "other_relevant": [0-4条, 其他相关但不属上面 4 类]
}}
